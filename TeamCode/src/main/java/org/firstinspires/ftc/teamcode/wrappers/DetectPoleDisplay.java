...
public class DetectPoleDisplay extends OpenCvPipeline {
    ...
    private Mat mask = new Mat(), hierarchy = new Mat();
    ...
    public Mat processFrame(Mat input) {
        ...
        if (contours.size() > 0) {
            ...
            if (maxIndex != -1) {
                ...
                Imgproc.rectangle(input, new org.opencv.core.Point(maxRect.x, maxRect.y), new org.opencv.core.Point(maxRect.x + maxRect.width, maxRect.y + maxRect.height), new Scalar(0, 255, 0), 2);
